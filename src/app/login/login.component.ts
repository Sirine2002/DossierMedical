          ...
          .then((snapshot) => {
              ...
              this.db.database.ref(collection)
                ...
                .then((snap) => {
                  if (snap.exists()) {
                    ...
                    console.warn(` Aucune donnée dans ${collection}`);
                  }
                  this.loginPass = "Connexion réussie!";
            ...
            switch (role) {
              ...
              case 'medecin':
                ...
                case 'Analyste':
                  case 'analyste':
                    loadAdditionalData('analystes', 'analysteData', '/liste-des-patients');
                    break;
                  case 'Radiologue':
                  case 'radiologue':
                    loadAdditionalData('radiologues', 'radiologueData', '/liste-des-patients');
                    break;
              default:
